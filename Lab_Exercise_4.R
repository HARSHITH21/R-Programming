...
# Count words in each product title and store the result in a new column
data$numofwords <- sapply(data$product_title, count_words)
...
print("DataFrame with word counts:")
print(data)
cat("\nRunning time:", running_time, "seconds\n")

# [1] "DataFrame with word counts:"
...
# search_term relevance numofwords
# 1                                     angle bracket      3.00          4
# 2                                         l bracket      2.50          4
# 3                                         deck over      3.00         11
# 4                                  rain shower head      2.33         13
# 5                                shower only faucet      2.67         13
# 6                                    convection otr      3.00         15
# 7                              microwave over stove      2.67         15
# 8                                        microwaves      3.00         15
# 9                                   emergency light      2.67          9
# 10                                          mdf 3/4      3.00         14
# 11                                     steele stake      2.67          6
# 12                   briggs and stratton lawn mower      3.00         17
# 13                                         gas mowe      3.00         17
# 14                                      honda mower      2.00         17
# 15               hampton bay chestnut pull up shade      2.67         16
# 16                                         disposer      2.67          8
# 17                                     grill gazebo      3.00         15
# 18                                      door guards      1.00         12
# 19                           metal plate cover gcfi      1.67         12
# 20                                   radiator grate      2.33         12
# 21                                  windows screens      2.33         12
# 22                         1x1 rail decorative wood      1.33         12
# 23                           4*8 beadboard paneling      2.67         12
# 24                                 4x8wood paneling      2.33         12
# 25                                          MDF 4x8      1.33         12
# 26                              wainscot chair rail      2.33         12
# 27                          wainscot plank paneling      2.33         12
# 28                                   lawn sprkinler      2.00         10
# 29                               rainbird sprinkler      2.33         10
# 30                             PLATFORM FOR WASHERS      2.67         13
# 31                    samsung front load washer 3.7      2.00         13
# 32           upholstery washing machines with steam      2.33         13
# 33              CONCRETE & MASONRY CLEANER & ETCHER      3.00          5
# 34                               concrete for ponds      2.00          5
# 35                              flexlock for cracks      2.00          5
# 36                             Belgium block pavers      2.00         14
# 37                               ourdoor patio tile      2.33         14
# 38                                  insulation roll      2.33          8
# 39                             6ft h bamboo fencing      2.00         11
# 40                           balcony privacy screen      2.67         11
# 41                                           bamboo      1.67         11
# 42                           privacy lattice panels      2.33         11
# 43                                   privacy panels      1.67         11
# 44                                      chalk paint      3.00          7
# 45                                   8 4616809045 9      1.67          9
# 46                                    shelf bracket      3.00          9
# 47                                   white 4shelves      1.67          9
# 48                                  6 teir shelving      3.00         19
# 49                                hdx wire shelving      3.00         19
# 50                        kitchen  cabinet finishes      1.00         19
# 51                        kitchen wire shelf tiered      3.00         19
# 52                                      pantry rack      2.67         19
# 53                            plastic storage racks      2.67         19
# 54                                    Shelves Metal      3.00         19
# 55                                   steel shelving      2.67         19
# 56                                   storage shelve      3.00         19
# 57                                     mortar tools      1.00          3
# 58                              12 boltless bracket      2.33          7
# 59              12 in.  16 in single track brackets      2.33          7
# 60                            12 wire shelf bracket      3.00          7
# 61                                      shelf track      2.33          7
# 62                                   husky tool bag      2.50          4
# 63              impact driver drill battery powered      2.33          9
# 64                                    impact wrench      3.00          9
# 65                                     pellet stove      2.33         10
# 66                                register for fuel      2.33         10
# 67                                     stove and mi      2.33         10
# 68                               ventless gas stove      3.00         10
# 69              American Standard Bone round toliet      3.00         13
# 70                        cadet 3 insulated in bone      2.33         13
# 71                                          grayson      2.33         12
# 72                                          6 stell      2.00          9
# 73                                 fece posts metal      2.00          9
# 74                         green painted pop rivets      2.33          9
# 75                                             post      2.67          9
# 76                           wire fencing 6 ft high      1.67          9
# 77                                bolt 1/2 in by 12      3.00         14
# 78                                      metal sheet      2.33         14
# 79                                      sheet metal      3.00         14
# 80                         elastomeric roof coating      2.00          7
# 81                                   outdoor dining      2.67         11
# 82                           cushions outdoorlounge      3.00         14
# 83                               hampton bay spring      3.00         14
# 84                                 outdoorfurniture      2.33         14
# 85                                         wiremesh      3.00          7
# 86                                      front doors      3.00         16
# 87                               prehung steel door      3.00         16
# 88                                    stanley doors      2.67         16
# 89                     kingsley moen kitchen faucet      2.33         14
# 90                              kitchen sink faucet      3.00         14
# 91                 pricepfister kitchen faucet g135      2.00         14
# 92                                   soap dispenser      2.67         14
# 93                           soap dispenser kitchen      2.00         14
# 94                                      roof melter      1.33          7
# 95                         6 kraft faced insulation      2.33         12
# 96                            fiberglass insulation      2.33         12
# 97                                owens corning 7-3      2.00         12
# 98                                             R 15      1.33         12
# 99                                   r19 insulation      3.00         12
# 100                                battery lanterns      3.00          7
# 101       ceiling light battery powered with remote      2.33          7
# 102                                 emergency light      3.00          7
# 103                                   planters pots      2.67          8
# 104                                        5x5 post      2.33         20
# 105                                     column post      3.00         20
# 106                                            post      2.33         20
# 107                                   bazz lighting      2.00         11
# 108                                        led rope      2.67         11
# 109                                led strip lights      2.67         11
# 110                                     TILES 12*12      2.67         17
# 111                           10  rough toilet bowl      2.33         12
# 112                               delta canister 17      1.33         12
# 113                              glaciar bay toiled      2.00         12
# 114                           glacie bay dual flush      2.33         12
# 115   glacier bay high efficiency toilet fill valve      2.00         12
# 116                     glacier bay tiolet tank lid      2.67         12
# 117                                 handicap toilet      2.67         12
# 118                                handycap toilets      2.33         12
# 119                                  high boy tolet      2.33         12
# 120                     kohler rosario toilet parts      1.33         12
# 121                                     toilet bowl      2.33         12
# 122                                toilet flush kit      2.67         12
# 123                              toilet glacier bay      3.00         12
# 124                      60 heater gallon gas water      2.33         16
# 125                               gas wayer heaters      2.00         16
# 126                                      heater gas      1.67         16
# 127                           hot water heater cost      2.67         16
# 128                            hot water heater gas      3.00         16
# 129                   rheem gas water heater prog40      2.67         16
# 130                          rheem water heater gas      3.00         16
# 131                         rheem water heater plug      2.33         16
# 132                              rheum water heater      3.00         16
# 133                          water heater certified      3.00         16
# 134                               water heater pans      1.67         16
# 135                                    shark vacuum      3.00          6
# 136                               under cabinet led      3.00         12
# 137                          under cabinet lighting      3.00         12
# 138             under counter fluorescent bar light      2.33         12
# 139                           undercounter lighting      3.00         12
# 140                                  doors exterior      2.33         10
# 141                                    Double Doors      3.00         10
# 142                              prehung steel door      3.00         10
# 143                            steel patio railings      1.33         10
# 144                             3 blue masking tape      1.67         12
# 145                                    masking tape      3.00         12
# 146                                             4x6      3.00         11
# 147                             treated fence posts      3.00         14
# 148                       1/2 x 5 black pipe nipple      1.67          9
# 149                              galvanized gas tee      3.00          9
# 150                                  area rugs 9x12      2.67         12
# 151                                  18  dishwasher      1.67         10
# 152 30' x 60 'molded one piece acrylic shower stall      2.33         16
# 153                               one piece showers      2.33         16
# 154                                     bakers rack      3.00          6
# 155                                basemetnt window      1.33          9
# 156                            editing garage floor      2.00         12
# 157                                 rustollum epoxy      3.00         12
# 158                                  car ramps ends      2.00          7
# 159                             plexiglas 18' x 24'      2.00         21
# 160                                          melnor      3.00          5
# 161                                 A/c window unit      3.00          8
# 162                   air /heaterconditioner window      3.00          8
# 163                                  room a/c units      2.67          8
# 164                                 spliter ac unit      2.33          8
# 165                               window air condit      2.33          8
# 166              Window Unit Air Conditioner/Heater      2.67          8
# [ reached 'max' / getOption("max.print") -- omitted 73901 rows ]

#Running time: 7.69527 seconds
...
# Function to count words in a string
count_words <- function(sentence) {
  length(unlist(strsplit(as.character(sentence), " ")))
}

# Measure start time
start_time <- Sys.time()

# Count words in each product title using sapply and store the result in a new column
data$numofwords <- sapply(data$product_title, count_words)
...
# Calculate running time
running_time_sapply <- end_time - start_time

# Print the updated dataframe
print(data)

cat("\nRunning time using sapply:", running_time_sapply, "seconds\n")
...
#Running time using sapply: 0.548316 seconds
...
# Count words in each product title using sapply and store the result in a new column
data$numofwords <- lapply(data$product_title, count_words)

# Measure end time
end_time <- Sys.time()

# Calculate running time
running_time_lapply <- end_time - start_time
...
cat("\nRunning time using lapply:", running_time_lapply, "seconds\n")
#Running time using lapply: 0.5452111 seconds
...
# Apply count_words function to each row of the product_title column
data$numofwords <- apply(data[, "product_title", drop = FALSE], 1, count_words)

# Measure end time
end_time <- Sys.time()

# Calculate running time
running_time_apply <- end_time - start_time
...
# [ reached 'max' / getOption("max.print") -- omitted 73901 rows ]
# 
# cat("\nRunning time using apply:", running_time_apply, "seconds\n")
# Running time using apply: 0.6187 seconds
# 
# #using forloop
# 
# # Repeating the for-loop implementation for comparison
# 
# # Read data from train.csv file
# data <- read.csv("train.csv")
# 
...
# start_time <- Sys.time()
# 
# # Count words in each product title using for loop and store the result in a new column
# data$numofwords <- 0
# for (i in 1:nrow(data)) {
#   data$numofwords[i] <- count_words(data$product_title[i])
# }
# 
# # Measure end time
# end_time <- Sys.time()
# 
# # Calculate running time
# running_time_for_loop <- end_time - start_time
# 
# # Print the updated dataframe
# print(data)
# 
...
cat("\nRunning time using for loop:", running_time_for_loop, "seconds\n")
#Running time using for loop: 8.850345 seconds

#3

# Load data with proper encoding
data <- read.csv("train.csv", fileEncoding = "UTF-8")

# Function to calculate number of common words between two strings
count_common_words <- function(product_title, search_term) {
  product_words <- unlist(strsplit(tolower(as.character(product_title)), " "))
  search_words <- unlist(strsplit(tolower(as.character(search_term)), " "))
  common_words <- intersect(product_words, search_words)
  return(length(common_words))
}

# Initialize a list to store counts for each relevance score level
common_words_counts <- list()

# Iterate over each relevance score level
for (score in unique(data$relevance)) {
  # Filter data for the current relevance score level
  relevant_data <- subset(data, relevance == score)
  
  # Initialize variable to store total number of pairs for the current relevance score level
  total_pairs <- nrow(relevant_data)
  
  # Initialize variable to store total number of common words for the current relevance score level
  total_common_words <- 0
  
  # Iterate over each row of the relevant data
  for (i in 1:total_pairs) {
    # Calculate number of common words and add to total_common_words
    count <- count_common_words(relevant_data$product_title[i], relevant_data$search_term[i])
    total_common_words <- total_common_words + count
  }
  
  # Calculate average number of common words for the current relevance score level
  average_common_words <- total_common_words / total_pairs
  
  # Print relevance score level and average number of common words
  cat("Relevance Score Level:", score, "\t Average Number of Common Words:", average_common_words, "\n")
}

# Relevance Score Level: 3 	 Average Number of Common Words: 1.660194 
# Relevance Score Level: 2.5 	 Average Number of Common Words: 0.5 
# Relevance Score Level: 2.33 	 Average Number of Common Words: 1.359375 
# Relevance Score Level: 2.67 	 Average Number of Common Words: 1.245614 
# Relevance Score Level: 2 	 Average Number of Common Words: 1.372093 
# Relevance Score Level: 1 	 Average Number of Common Words: 0.1666667 
# Relevance Score Level: 1.67 	 Average Number of Common Words: 0.9259259 
# Relevance Score Level: 1.33 	 Average Number of Common Words: 0.6153846 
# Relevance Score Level: 1.25 	 Average Number of Common Words: 0 
# Relevance Score Level: 2.75 	 Average Number of Common Words: 2 
# Relevance Score Level: NA 	 Average Number of Common Words: Inf 
